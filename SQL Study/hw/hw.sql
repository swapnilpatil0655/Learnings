...
select * from bank_details;
-- select * from clasm.bank_details;--  for run direct after use practice to see the data inside the table bank -- 

select * from bank_details where job in ("management","unknown","technician");

select * from bank_details where age between 30 and 40;
...
select * from bank_details where housing = "no" or marital ="single"

select * from bank_details where balance between 1000 and 1600;

select * from bank_details where job="admin." and marital="single"

select * from bank_details where housing ="no" and loan="no";
